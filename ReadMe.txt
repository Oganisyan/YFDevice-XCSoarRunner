================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: YFDevice-Projektübersicht
===============================================================================

Der Anwendungs-Assistent hat diese YFDevice-Anwendung für Sie 
...
finden, aus denen Ihre YFDevice–Anwendung besteht.
...
YFDevice.h
    ...
    projektspezifische Header und deklariert die CYFDeviceApp-
    Anwendungsklasse.

YFDevice.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CYFDeviceApp-
...
YFDeviceDlg.h, YFDeviceDlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CYFDeviceDlg–Klasse. Diese Klasse 
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "YFDevice.pch2 und eine 
